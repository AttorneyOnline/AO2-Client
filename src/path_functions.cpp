...
QPair<QString, int> AOApplication::get_pos_path(const QString &pos,
                                                const bool desk)
{
  ...
  if (pos == "def" &&
      file_exists(get_image_suffix(get_background_path("court")))) {
    f_pos = "court:def";
  }
  else if (pos == "pro" &&
           file_exists(get_image_suffix(get_background_path("court")))) {
  ...
  if (pos == "def" &&
      file_exists(get_image_suffix(get_background_path("defenseempty")))) {
    f_background = "defenseempty";
    f_desk_image = "defensedesk";
  }
  else if (pos == "pro" && file_exists(get_image_suffix(
                               get_background_path("prosecutorempty")))) {
    f_background = "prosecutorempty";
    f_desk_image = "prosecutiondesk";
  }
  else if (pos == "jud" &&
           file_exists(get_image_suffix(get_background_path("judgestand")))) {
