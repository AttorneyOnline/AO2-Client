...
void AOOptionsDialog::setupUI()
{
  ...
  FROM_UI(QCheckBox, set_restore_courtroom_window_position_cb)
  ...
  registerOption<QCheckBox, bool>("restore_courtroom_window_position_cb",
                                  &::Options::restoreCourtroomWindowPositionEdit,
                                  &Options::setRestoreCourtroomWindowPositionEdit);
