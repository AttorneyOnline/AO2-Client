...
// Parse loop-point metadata from an AO music metadata file (the `.txt` that
// lives next to a music file). Recognises `seconds=(true|false)`,
// `loop_start=N`, `loop_end=N`, `loop_length=N`.
//
...
// metadata actually contains a non-seconds entry — and should return the
