...
public:
  ...
  // from the config.ini.
  bool objectionSkipQueueEnabled();
  ...
  // from the config.ini
  bool desynchronisedLogsEnabled();
  ...
  // from the config.ini.
  bool stopMusicOnCategoryEnabled();
