    ...
    : QWidget(p_parent), ao_app(p_ao_app)
{
  ...
  ui_vp_background->setSizePolicy(QSizePolicy::Policy::Expanding,
  ...
  ui_vp_speedlines->setSizePolicy(QSizePolicy::Policy::Expanding,
                                  QSizePolicy::Policy::Expanding);
  ...
  ui_vp_player_char->setSizePolicy(QSizePolicy::Policy::Expanding,
                                   QSizePolicy::Policy::Expanding);
  ...
  ui_vp_sideplayer_char->setSizePolicy(QSizePolicy::Policy::Expanding,
                                       QSizePolicy::Policy::Expanding);
  ...
  ui_vp_desk->setSizePolicy(QSizePolicy::Policy::Expanding,
                            QSizePolicy::Policy::Expanding);
  ...
  ui_vp_effect->setSizePolicy(QSizePolicy::Policy::Expanding,
                              QSizePolicy::Policy::Expanding);
  ...
  ui_vp_evidence_display->setSizePolicy(QSizePolicy::Policy::Expanding,
                                        QSizePolicy::Policy::Expanding);
  ...
  ui_vp_sticker->setSizePolicy(QSizePolicy::Policy::Expanding,
                               QSizePolicy::Policy::Expanding);
  ...
  ui_vp_chat_arrow->setSizePolicy(QSizePolicy::Policy::Expanding,
                                  QSizePolicy::Policy::Expanding);
  ...
  ui_vp_testimony->setSizePolicy(QSizePolicy::Policy::Expanding,
                                 QSizePolicy::Policy::Expanding);
  ...
  ui_vp_wtce->setSizePolicy(QSizePolicy::Policy::Expanding,
                            QSizePolicy::Policy::Expanding);
  ...
  ui_vp_objection->setSizePolicy(QSizePolicy::Policy::Expanding,
                                 QSizePolicy::Policy::Expanding);
