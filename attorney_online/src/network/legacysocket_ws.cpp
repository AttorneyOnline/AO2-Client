                                        ...
                                        const uint16_t &port)
{
  ...
  QObject::connect(&socket, &QWebSocket::textMessageReceived, this,
                   &LegacySocket_WS::packetReceived);
  ...
  auto promise =
      QtPromise::connect(&socket, &QWebSocket::connected, errorFunc)
          .then([&] {
            QObject::connect(&socket, &QWebSocket::disconnected, this,
                             &LegacySocket_WS::connectionLost);
          })
  ...
  return QPromise<QStringList>(
      [&](const QPromiseResolve<QStringList> &resolve) {
        ...
        *connection = QObject::connect(
            this, &LegacySocket_WS::messageReceived,
